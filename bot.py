...
QUESTIONS = {
    ...
    "الفيزياء": [
        ...
        {"q": "سرعة الضوء تقريباً؟", "a": ["3×10^8 م/ث", "3×10^6 م/ث", "3×10^5 م/ث", "3×10^9 م/ث"], "correct": 0},
    ],
}
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "🎓 مرحباً بك في بوت امتحانات الجامعة العراقية!\n\nاختر سنتك الدراسية:",
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("year_"):
        ...
        if chosen == correct:
            ...
            result = f"❌ خطأ! الصواب: {QUESTIONS[subject][index]['a'][correct]}"
